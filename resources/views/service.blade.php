<x-app-layout>
  ...
  <div class="container mx-auto flex justify-center  px-4 md:px-12">

    <div
      class="block rounded-lg mb-20 bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
      <h2 class="text-3xl font-extrabold mb-10  text-green-500 text-center">Contact Us</h2>
      <div class="flex flex-wrap">
        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
          <form>
            ...
            <button type="button"
                class="mb-6 w-full bg-green-500 hover:bg-green-600  px-6 py-2 rounded-lg transition-colors duration-200; text-white pt-2.5 pb-2 text-xs font-medium uppercase leading-normal   lg:mb-0">
                Send
              </button>
          </form>
        </div>
